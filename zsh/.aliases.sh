...
alias ac='git annex find --not --in b2 --print0 | git annex copy --batch -z --to b2 -J6'
...
alias af='git annex find --not --in b2'
  ...
  linux*)
    ...
    case "${distro}" in
      arch)
        ...
        alias pu='systemd-inhibit sudo pacman -Syu && flatpak update && paru' # Package update (all from Arch repo)
